...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 24 14:39:46 2023
...
#x-verdiene for å få en mer nøyaktig verdi
print("y-value for legphase:", y_endelig)


#%%Plotte

plt.plot(x,y) # Plotter sigmoidkurven
plt.plot(x_endelig, y_endelig,"gX") #Plotter halveringspunktet
...
plt.xticks(np.arange(min(x), max(x)+1, 50)) #Definerer verdiene på x-aksen, har intervaller på 50
plt.yticks(np.arange(min(y), max(y)+1, 10)) #Definerer verdiene på y-aksen, har intervaller på 10
